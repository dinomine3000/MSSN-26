...
public class WorldConstants {
    ...
    public static final long[] GROW_TIME_MODIFIERS = {0, 10000, 5000, 0};
    public static final float TIME_TO_CHANGE_SEASONS = 60f; // seconds
    public final static double[] PATCH_TYPE_PROB = {0.35f, 0f, 0f, 0.35f, 0.3f};
    ...
    public static final boolean DO_HIBERNATION = false;
    public static final float HIBERNATION_WEIGHT_VARIATION = 1f;
    ...
    public final static int INI_PREY_POPULATION = 40;
    public final static float INI_PREY_ENERGY = 40.f;
    public final static float ENERGY_FROM_PLANT = 5.f;
    public final static float PREY_ENERGY_TO_REPRODUCE = 30.f;
    ...
    public final static int INI_SCAV_POPULATION = 1;
    public final static float INI_SCAV_ENERGY = 15.f;
    public final static float SCAV_ENERGY_FROM_PLANT = 5.f;
    public final static float SCAV_ENERGY_TO_REPRODUCE = 30.f;
